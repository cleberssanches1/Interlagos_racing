...
struct LowWorkTraceTextViewPacket
{
    bool valid = false;
    bool shouldShowStageDeltasA = false;
    bool shouldShowStageDeltasB = false;
    bool shouldShowFrameDeltas = false;
    bool shouldShowTrackDrawDeltas = false;
    bool shouldShowAllocatorDeltas = false;
